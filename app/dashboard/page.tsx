        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <span className="text-sm text-muted-foreground">
              Your daily insights at a glance
            </span>
          </div>
          ...
          <Card className="p-7 rounded-2xl bg-gradient-to-tr from-blue-50 to-blue-200 shadow-xl border-0 transition hover:-translate-y-1 hover:shadow-2xl group">
            <div className="flex items-center gap-4">
              <div className="bg-blue-400/10 p-3 rounded-full group-hover:bg-blue-500/10 transition">
                ...
                >
                  <path
                    d="M12 3C7 3 2.73 7.11 3.05 12.04C3.34 16.41 7.01 20 12 20C16.99 20 20.66 16.41 20.95 12.04C21.27 7.11 17 3 12 3ZM12 18C8.13 18 5 14.86 5 11C5 7.13 8.13 4 12 4C15.87 4 19 7.13 19 11C19 14.86 15.87 18 12 18ZM12 6C9.24 6 7 8.24 7 11C7 13.76 9.24 16 12 16C14.76 16 17 13.76 17 11C17 8.24 14.76 6 12 6Z"
                    fill="currentColor"
                  />
                </svg>
              </div>
              <div>
                ...
                <div className="text-3xl font-extrabold mt-2 text-blue-700 animate-fade-in-up">
                  24
                </div>
                <p className="mt-1 text-blue-600/70 text-sm">
                  Active this period &#x2022; +3 new
                </p>
          ...
          <Card className="p-7 rounded-2xl bg-gradient-to-tr from-yellow-50 to-yellow-200 shadow-xl border-0 transition hover:-translate-y-1 hover:shadow-2xl group">
            <div className="flex items-center gap-4">
              <div className="bg-yellow-400/10 p-3 rounded-full group-hover:bg-yellow-500/10 transition">
                ...
                >
                  <path
                    d="M12 4V13L17 16.5L15.53 18.74L9.27 14.97L12 13V4ZM12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z"
                    fill="currentColor"
                  />
                </svg>
              </div>
              <div>
                ...
                <div className="text-3xl font-extrabold mt-2 text-yellow-700 animate-fade-in-up">
                  5
                </div>
                <p className="mt-1 text-yellow-700/60 text-sm">
                  Due soon &#x2022; 1 overdue
                </p>
          ...
          <Card className="p-7 rounded-2xl bg-gradient-to-tr from-green-50 to-green-200 shadow-xl border-0 transition hover:-translate-y-1 hover:shadow-2xl group">
            <div className="flex items-center gap-4">
              <div className="bg-green-400/10 p-3 rounded-full group-hover:bg-green-500/10 transition">
                ...
                >
                  <path
                    d="M12 21C7.03 21 2.73 16.72 3.05 11.76C3.34 7.38 7.01 3.8 12 3.8C16.98 3.8 20.65 7.38 20.95 11.76C21.27 16.72 16.97 21 12 21ZM15 11L10.5 14L8 12.17L9.41 10.59L10.5 11.46L13.59 9L15 11Z"
                    fill="currentColor"
                  />
                </svg>
              </div>
              <div>
                ...
                <p className="mt-1 text-green-700/60 text-sm">
                  This month &#x2022; +10%
                </p>
                <Progress
                  value={showRevenue ? 73 : 0}
                  className="h-2 bg-green-100 mt-3 transition-all"
                />
              </div>
            </div>
          </Card>
      ...
      <SmartRemindersPanel reminders={reminderData} />
        ...
        <div className="flex flex-wrap gap-4 mb-10">
          {fakeQuickStats.map((stat) => (
            ...
            >
              <span
                className={`h-3 w-3 rounded-full ${stat.color} mr-3`}
              ></span>
              <div>
                  ...
                  {act.type === "message" && (
                    ...
                    >
                      <path
                        stroke="currentColor"
                        strokeWidth={2}
                        d="M3.5 5.5a2 2 0 0 1 2-2H14.5a2 2 0 0 1 2 2v8.5a2 2 0 0 1-2 2H5.5a2 2 0 0 1-2-2V5.5Z"
                      />
                      <path
                        stroke="currentColor"
                        strokeWidth={2}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <Card
              className="flex items-center gap-4 py-5 px-7 rounded-xl border-0 shadow hover:shadow-lg cursor-pointer group transition"
            ...
            >
              <div className="rounded-full bg-blue-50 p-3 group-hover:bg-blue-100 transition">
                <svg width={28} height={28} viewBox="0 0 24 24" fill="none">
                  <path
                    d="M12 12C13.66 12 14.99 10.66 14.99 9S13.66 6 12 6 9 7.34 9 9s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V20h14v-1.5c0-2.33-4.67-3.5-7-3.5z"
                    fill="#2563eb"
                  />
                </svg>
              </div>
            ...
            >
              <div className="rounded-full bg-yellow-50 p-3 group-hover:bg-yellow-100 transition">
                <svg width={28} height={28} fill="none" viewBox="0 0 24 24">
                  <path
                    d="M8 6V7a4 4 0 1 0 8 0V6m-9 6h10M10 16H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-3"
                    stroke="#eab308"
                    strokeWidth={2}
                    strokeLinecap="round"
                  />
            ...
            >
              <div className="rounded-full bg-green-50 p-3 group-hover:bg-green-100 transition">
                <svg width={28} height={28} fill="none" viewBox="0 0 24 24">
                  <path
                    d="M2 6v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6"
                    stroke="#22c55e"
                    strokeWidth={2}
                  />
                  <rect
